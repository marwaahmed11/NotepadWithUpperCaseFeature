...
else if(cmdText.equals(editUpperCase))
	ta.setText(convert(ta.getSelectedText()));
////////////////////////////////////
...
Upper_CaseItem=createMenuItem(editUpperCase,KeyEvent.VK_L,editMenu,this);
editMenu.addSeparator();
...
MenuListener editMenuListener=new MenuListener()
{
   public void menuSelected(MenuEvent evvvv)
	...
	Upper_CaseItem.setEnabled(false);
	}
	else
	{
	...
	Upper_CaseItem.setEnabled(true);
	}
	}
...
final String editUpperCase="Upper_Case";
